...
public class UserGeneralController {
	...
	public static UserGeneralController getInstance() {
		...
		instanceCtrl.registrator = new UserRegistrationController(defaultCtrl.registrator);
	...
	private UserRegistrationController registrator;
	...
	public UserRegistrationController getRegistrator() {
		return registrator;
	}
