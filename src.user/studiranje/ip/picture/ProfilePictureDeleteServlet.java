...
public class ProfilePictureDeleteServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			UserRequisit ureq = (UserRequisit) controller.getRegistrator().getUserDataLink().getRequisit(username); 
			if(ureq.getProfilePicture() != null) controller.deleteProfileImage(username);
			info.reset();
